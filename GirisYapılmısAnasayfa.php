  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	  ...
	  <li class="dropdown">
            ...
            <ul class="dropdown-menu">
            <li><a href="http://localhost/web/ilan/%c4%b0lanGiris.php">İlan Girişi</a></li>
            <li><a href="http://localhost/web/ilan/ilanduzenle.php">İlanlarım</a></li>
	  ...
	  <li class="dropdown">
		...
		<li class="dropdown">
            ...
            <ul class="dropdown-menu">
            <li><a href="http://localhost/web/admin/ilansil.php">İlan Silme</a></li>
            <li><a href="http://localhost/web/admin/uyeban.php">Üye Ban</a></li>
