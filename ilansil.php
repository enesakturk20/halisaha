...
<html>
    ...
    <title>Admin İşlemleri/İlan Silme</title>
...
<br><br><br><br><br><br><br><br><br><br>
   ...
   <form class="navbar-form navbar-left" action="baglan_ilansil.php" method="POST">
        <div class="form-group">
          <input type="text" class="form-control" name="ilan_sil" placeholder="İlan Başlığı">               
        </div>
        <br><br><br>
         <li> <button type="submit" >İlanı Sil</button></li>
