...
<br>
          <head>
              <title><font color="black">Örnek Kullanıcı Profili</font></title>
              <meta charset="utf-8">
              <meta name="viewport" content="width=device-width, initial-scale=1">
          ...
          <div class="row">
              <div class="col-sm-10"><h1><font color="black">Kullanıcı Adı</font></h1></div>
          ...
          <form class="form" action="baglan_profil.php" method="POST" id="registrationForm">
              <div class="form-group">
                  <div class="col-xs-6">
        ...
        <li> <button type="submit" >Kaydet</button></li> 
         ...
         <li> <button type="submit" >Hesap Sil</button></li> 
         </a>
          </div>
          </div>
