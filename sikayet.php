...
<html>
    ...
    <title>Şikayet Et / Engelle</title>
...
<body>
    <div class="container">
        <form action="baglan_sikayet.php" method="POST">
            <div class="row">
                <div class="col-25">
                    <label for="lname">Şikayet Edilen Kullanıcı Adı</label></div>
                <div class="col-75">
                    <input type="text" id="lname" name="sikayet" placeholder="Kullanıcı Adı..."></div>
            </div>
            <div class="row">
                <div class="col-25">
                ...
                <div class="col-75">
                    <input type="text" id="fname" name="firstname" placeholder="Adınız.."></div>
            </div>
            <div class="row">
                <div class="col-25">
                    <label for="lname">Soyadınız</label></div>
                <div class="col-75">
                    <input type="text" id="lname" name="lastname" placeholder="Soyadınız.."></div>
            </div>
            
            <div class="row">
                <div class="col-25">
                    <label for="country">Şikayet Sebebiniz</label></div>
                <div class="col-75">
                    <select id="reports" name="reports">
                        <option>Uygunsuz İçerik</option>
                        <option>Spam</option>
                        <option>Hakaret/Küfür</option>
                    </select></div>
            </div>
            
            <div class="row">
                <div class="col-25">
                    <label for="subject">Diğer</label></div>
                <div class="col-75">
                    <textarea id="subject" name="subject"  style="height:200px"></textarea></div>
            </div>
            
            <div class="row">
                <input type="submit" value="Şikayet Et / Engelle"></div>
        </form>
    </div>
