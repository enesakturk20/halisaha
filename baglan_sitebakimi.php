...
$bakim_row = mysql_fetch_array(mysql_query("SELECT * FROM ayarlar WHERE ayar_name='site_durumu'")); 
$site_durum = $bakim_row["ayar_dg"];
if ($site_durum == "1") {
  // Buraya bakıma alındığında site üzerinde gözükecek kod gelicek.
  
   
  // Örnek birkaç kod ise
    # die("Site bakıma alınmıştır");
   
  // Veya örnek mysql'deki bakım mesajı şekli
    # die($bakim_row["ayar_deger"]);
