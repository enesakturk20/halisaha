    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	  ...
	  <li class="dropdown">
		...
		<li class="dropdown">
            ...
            <ul class="dropdown-menu">
            <li><a href="ilansil.html">İlan Silme</a></li>
...
<div style="margin-left:px;"><div style="margin-left:50px;"><h1><em>İlanlarım</em> </h1></div>

<br>

<div class="alert alert-success" role="alert">
  <h4 class="alert-heading">Örnek İlanım - 1</h4>
  <p>Saha İsmi : Batıkent</p>
  <p>Tarih : 29.11.2019</p>
  <p>Saat : 20:00</p>
  <p>Mevkii : Kaleci ve Forvet
  <p>Ek Bilgi : ...</p>
  <p> <div style="margin-left:px;"> <button onclick="window.location.href='İlanGiris.php'">İlanı Düzenle</button>	/
  <button onclick="window.location.href='file:///C:/Program%20Files%20(x86)/Brackets/samples/root/Getting%20Started/web%20geli%C5%9Ftirici/Html5/ilansil.html'">İlanı Sil</button>	</div>
